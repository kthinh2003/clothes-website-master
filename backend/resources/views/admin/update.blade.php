        ...
        <div class="card-header d-flex justify-content-between align-items-center">
            <h5 class="mb-0">
                <font style="vertical-align: inherit;">
                    <font style="vertical-align: inherit;">Edit Admin</font>
                </font>
            </h5>
            
        </div>
        <div class="card-body">
            <form action="{{route('admin.updateHandle',['id' => $admin->id])}}" method="post">
                @csrf
                <div class="mb-3">
                    ...
                    <div class="input-group input-group-merge">
                        ...
                        <input type="text" name="username" value="{{ $admin->username }}" class="form-control" id="basic-icon-default-fullname" placeholder="John Doe" aria-label="John Doe" aria-describedby="basic-icon-default-fullname2">
                    </div>
                </div>
                <div class="form-text">
                    <font style="vertical-align: inherit;">
                ...
                <div class="mb-3">
                    ...
                    <div class="input-group input-group-merge">
                        <span id="basic-icon-default-fullname2" class="input-group-text"><i class="bx bx-user"></i></span>
                        <input type="text" name="fullname" value="{{ $admin->fullname }}" class="form-control" id="basic-icon-default-fullname" placeholder="John Doe" aria-label="John Doe" aria-describedby="basic-icon-default-fullname2">
                    </div>
                </div>
                <div class="form-text">
                    <font style="vertical-align: inherit;">
                ...
                <div class="mb-3">
                    ...
                    <div class="input-group input-group-merge">
                        ...
                        <input type="text" name="email" value="{{ $admin->email }}" id="basic-icon-default-email" class="form-control" placeholder="john.doe" aria-label="john.doe" aria-describedby="basic-icon-default-email2">
                ...
                <div class="mb-3">
                    ...
                    <div class="input-group input-group-merge">
                        ...
                        <input type="text" name="phone_number" value="{{ $admin->phone_number }}" id="basic-icon-default-phone" class="form-control phone-mask" placeholder="038 799 8941" aria-label="038 799 8941" aria-describedby="basic-icon-default-phone2">
